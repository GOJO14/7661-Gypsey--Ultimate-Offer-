...
public final class VariantAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.shopify.shopifyapp.productsection.viewholders.VariantItem> {
    ...
    @java.lang.Override()
    public com.shopify.shopifyapp.productsection.viewholders.VariantItem onCreateViewHolder(@org.jetbrains.annotations.NotNull()
    ...
    com.shopify.shopifyapp.productsection.viewholders.VariantItem holder, int position) {
    }
    
    private final void setVariants(com.shopify.shopifyapp.productsection.models.VariantData data, com.shopify.shopifyapp.productsection.viewholders.VariantItem holder, java.util.List<? extends com.shopify.buy3.Storefront.SelectedOption> selectedOptions) {
    }
    ...
    com.shopify.shopifyapp.productsection.viewmodels.ProductViewModel model, @org.jetbrains.annotations.Nullable()
